...
population <- read_csv("raw_data/census_population.csv", col_types = cols(
  GEO_ID = col_character(),
  NAME = col_character(),
  B01003_001E = col_character(),
  B01003_001M = col_character()
))
